                ...
                <Form ref="searchForm" :model="searchForm" inline :label-width="0">
                    <Form-item ref="searchForm" :model="searchForm" inline :label-width="0" style="display:flex;">
                        <Form-item label="" prop="title">
                            <Input type="text" v-model="searchForm.title" placeholder="手术名称" clearable
                                style="width: 200px" />
                        </Form-item>
                        <Form-item label="" prop="efficacy">
                            <Input type="text" v-model="searchForm.efficacy" placeholder="功能主治" clearable
                                style="width: 200px" />
                        </Form-item>
...
export default {
        ...
        return {
            ...
            columns: [
                ...
                },
                {
                    ...
                    render: (h, params) => {
                        var typeColor = "green";
                        if (params.row.type === "一级手术") {
                            typeColor = "volcano";
                        } else if (params.row.type === "二级手术") {
                            typeColor = "purple";
                        }
                        return h("div", [
                            h(
    ...
    methods: {
        ...
        getDataList() {
            this.loading = true;
            getOperationList(this.searchForm).then(res => {
                this.loading = false;
                if (res.success) {

<template>
    <div class="search">
        <Card>
                ...
                <Row>
                    <Form ref="searchForm" :model="searchForm" inline :label-width="85">
                        <Form-item label="原文件名" prop="name">
                            <Input type="text" v-model="searchForm.name" placeholder="请输入文件名" clearable
                                style="width: 160px" />
                        </Form-item>
                        ...
                        <Form-item style="margin-left:-35px;" class="br">
                            <Button @click="handleSearch" ghost shape="circle" type="primary" icon="ios-search"
                                size="small">搜索</Button>
                            <Button @click="handleReset" ghost shape="circle" type="warning" icon="md-refresh"
                                size="small">重置</Button>
                            <Button @click="uploadVisible = true" ghost shape="circle" type="success" icon="md-cloud-upload"
                                size="small">上传文件</Button>
                            <Button @click="fileSaveSettingModal = true" ghost shape="circle" type="info" icon="md-settings"
            ...
            <Row type="flex" justify="end" class="page">
                <Page :current="searchForm.pageNumber" :total="total" :page-size="searchForm.pageSize"
                    @on-change="changePage" @on-page-size-change="changePageSize" :page-size-opts="[15, 20, 40]"
                    size="small" show-total show-elevator show-sizer></Page>
            </Row>
        </Card>

        <Drawer title="文件上传" closable v-model="uploadVisible" width="500">
            <Upload action="/ins/upload/file" :headers="accessToken" :on-success="handleSuccess" :on-error="handleError"
        ...
        <Modal title="文件重命名" v-model="changeFileNameModal" :mask-closable="false" :width="500" ok-text="保存"
            @on-ok="handleSubmit">
        ...
        <Modal title="文件存储配置" v-model="fileSaveSettingModal" :mask-closable="false" :width="700" ok-text="保存"
            @on-ok="setFileSettingFx">
            <Form ref="settingForm" :model="settingForm" :label-width="95">
                <Row :gutter="16">
                    <Col span="24">
                    <FormItem label="存储路径">
                        <Input type="text" v-model="filePath" placeholder="如 C:\\oa-file" style="width: 100%"
                ...
                <Row :gutter="16">
                    <Col span="24">
                    <FormItem label="预览接口">
                        <Input type="text" v-model="fileView" placeholder="如127.0.0.1:8080/ins/file/view"
                            style="width: 100%">

    ...
    <div class="search">
        <Card>
            <Row :gutter="16">
                <Col span="7">
                <Row :gutter="16">
                    <div class="tree-bar" style="overflow-y: scroll;padding-right: 50px;"
                        :style="{ maxHeight: maxHeight + 'px' }">
                        <Tree ref="tree" :data="data" show-checkbox :render="renderContent" @on-select-change="selectTree"
                ...
                <Form ref="form" :model="form" :label-width="110" :rules="formValidate">
                    <Row :gutter="16">
                        ...
                        <Col span="12">
                        <Form-item>
                            <Button style="margin-right:5px" @click="submitEdit" ghost shape="circle"
                                :loading="submitLoading" type="primary" icon="ios-create-outline">保存菜单</Button>
                            <Divider type="vertical" />
                ...
                <Row :gutter="16">
                    <Table :loading="userByPermissionLoading" border stripe size="small" :columns="userByPermissionColumns"
                        :data="userByPermissionList"></Table>
                </Row>
                </Col>
            </Row>
        </Card>

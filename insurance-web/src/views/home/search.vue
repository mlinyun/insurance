<template>
    <div style="position: fixed;">
        <div :class="`search-menu search-menu-theme-${theme}`" v-if="type == 'input'">
            <Select v-model="key" prefix="ios-search" transfer clearable filterable placeholder="请选择添加的模块"
                @on-change="changeMenu" ref="select">
        ...
        <div class="search-dropdown" v-else>
            <Dropdown trigger="click" placement="bottom-start">
                ...
                <div slot="list" class="search-select">
                    <Select v-model="key" prefix="ios-search" transfer clearable filterable placeholder="艾是OA菜单查询"
                        @on-change="changeMenu" ref="select">

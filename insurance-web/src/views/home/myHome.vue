            ...
            <Form ref="userForm" :model="userForm" :label-width="90" label-position="left">
                ...
                <Row :gutter="16">
                    ...
                    <FormItem label="性别" prop="username">
                        <dict dict="sex" v-model="userForm.sex" transfer :readonly="!editFlag" placeholder="请选择性别"
                            style="width: 100%" />
                    </FormItem>
                    </Col>
                    <Col :span="12">
                    <FormItem label="头像" prop="avatar">
                        <upload-pic-thumb v-model="userForm.avatar" :multiple="false"
                            style="width: 100%"></upload-pic-thumb>
                    </FormItem>
                    </Col>
                </Row>
                <Row :gutter="16">
                    ...
                    <FormItem label="所在区县" prop="username">
                        <al-cascader v-model="userForm.addressArray" :disabled="!editFlag" @on-change="changeAddress"
                            data-type="code" level="2" style="width: 100%" />
                    </FormItem>
                    </Col>
                    <Col :span="12">
                ...
                <Row :gutter="16">
                    ...
                    <FormItem label="生日" prop="username">
                        <DatePicker v-model="userForm.birth" @on-change="changeBirth" :readonly="!editFlag"
                            style="width: 100%" type="date"></DatePicker>
                    </FormItem>
                    </Col>
                    <Col :span="12">
                    <FormItem label="个性签名" prop="nickname">
                        <Input v-model="userForm.description" type="textarea" :readonly="!editFlag" style="width: 100%"
                            :autosize="{ minRows: 3, maxRows: 5 }" placeholder="个性签名"></Input>
                    </FormItem>
                    </Col>
                </Row>
            </Form>
            ...
            <Row :gutter="16">
                ...
                <List header="header" footer="footer" border>
                    <ListItem v-for="(item, index) in addMenuTempList" :key="index">
                        {{ item.title }}
                        <Button @click="deleteOneMenu(item)" type="error" shape="circle" icon="md-trash" size="small"
                ...
                <Col span="12">
                <Divider>个人门户设置
                    <Button @click="addMenuFx" type="primary">保存更改</Button>
                </Divider>
                <Row :gutter="16">

        ...
        <Card>
            ...
            <Row :gutter="16">
                ...
                <Form ref="searchForm" :model="searchForm" inline :label-width="0">
                    ...
                    <Form-item label="">
                        <!-- 搜索框 -->
                        <Input type="text" v-model="searchForm.username" clearable placeholder="用户名"
                            style="width: 120px;" />
                    </Form-item>
                    <Form-item label="">
                        <!-- 时间选择框 -->
                    ...
                    <Form-item class="br">
                        ...
                        <Poptip trigger="hover" content="输入搜索条件后,点击搜索完成查询" placement="bottom">
                            ...
                            <Button @click="handleSearch" type="primary" icon="ios-search" size="small" ghost
                                shape="circle">搜索</Button>
                        </Poptip>
                        <Poptip trigger="hover" content="将所有搜索条件删除,搜索全部内容" placement="bottom">
                            <!-- 重置按钮 -->
                            <Button @click="handleReset" type="warning" size="small" ghost shape="circle"
                    ...
                    <Form-item style="position:fixed;right:50px;top:160px">
                        <Poptip trigger="hover" content="自定义表格的显示列,适应屏幕显示" placement="left">
                            ...
                            <Button type="info" @click="showFilterPanelFlag = !showFilterPanelFlag"
                                class="showFilterPanelFlag" icon="ios-settings" size="small" ghost>列筛选
                            </Button>
                        </Poptip>
                        <Poptip trigger="hover" content="点我查看本模块的使用教程" placement="left">
                            <!-- 教程按钮 -->
                            <Button type="warning" @click="modal1 = true" class="showFilterPanelFlag" icon="md-help"
                                size="small" ghost>使用教程
                            </Button>
                        </Poptip>
                        <!-- 教程内容的弹窗，显示日志档案教程 -->
            ...
            <Row>
                <!-- 表格组件，根据后台数据生成表格 -->
                <Table :loading="loading" border stripe size="small" :columns="columns" :height="tableHeight" :data="data"
                    ref="table" sortable="custom" context-menu show-context-menu @on-contextmenu="handleContextMenu"
            ...
            <Row type="flex" justify="end" class="page">
                ...
                <Page :current="searchForm.pageNumber" :total="total" :page-size="searchForm.pageSize"
                    ...
                    :page-size-opts="[5, 15, 25, 35, 45, 1000]" size="small" show-total show-elevator show-sizer></Page>
            </Row>
        </Card>
    </div>
</template>

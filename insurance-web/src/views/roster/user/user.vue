<template>
    <div class="search">
        <Card>
            <Row>
                <Form ref="searchForm" :model="searchForm" inline :label-width="40">
                    <Form-item label="姓名" prop="nickname">
                        <Input type="text" v-model="searchForm.nickname" clearable placeholder="搜索姓名"
                            style="width: 160px" />
                    </Form-item>
                    <Form-item label="部门" prop="department">
                        <department-choose @on-change="handleSelectDep" placeholder="用户部门" style="width: 160px"
                            ref="dep"></department-choose>
                    </Form-item>
                    <Form-item style="margin-left:10px;" class="br">
                        <Button @click="handleSearch" type="primary" icon="ios-search" ghost shape="circle"
                            size="small">搜索</Button>
                        <Button @click="handleReset" type="warning" ghost shape="circle" icon="md-refresh"
                            size="small">重置</Button>
                        <Button @click="add" type="info" icon="md-add" ghost shape="circle" size="small">添加</Button>
                        <Button @click="importModalVisible = true" type="success" icon="md-paper-plane" ghost shape="circle"
                            size="small">导入</Button>
                        <Button @click="excelData" type="success" icon="md-paper-plane" ghost shape="circle"
                            size="small">导出</Button>
                    </Form-item>
                    <Form-item style="position:fixed;right:50px;top:130px">
                        <Button type="info" @click="showFilterPanelFlag = !showFilterPanelFlag" class="showFilterPanelFlag"
                            icon="md-settings" size="small" ghost>
                            列筛选</Button>
                        <Button type="warning" @click="usingTutorialsModal = true" class="showFilterPanelFlag"
            ...
            <Row>
                <Table :loading="loading" border stripe :height="height" :columns="columns" :data="data" sortable="custom"
                    @on-sort-change="changeSort" @on-selection-change="showSelect" ref="table" @on-row-click="rowClick"
                    :row-class-name="rowClassName"></Table>
            </Row>
            <Row type="flex" justify="end" class="page">
                <Page :current="searchForm.pageNumber" :total="total" :page-size="searchForm.pageSize"
                    @on-change="changePage" @on-page-size-change="changePageSize" :page-size-opts="[20, 30, 50]" size="small"

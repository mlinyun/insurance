<template>
    <div class="search">
        ...
        <Card v-show="currView == 'index'">
                ...
                <Form ref="searchForm" :model="searchForm" inline :label-width="0">
                    <Form-item ref="searchForm" :model="searchForm" inline :label-width="0" style="display:flex;">
                        ...
                        <Form-item label="" prop="idCard">
                            <Input type="text" v-model="searchForm.idCard" placeholder="请输入身份证" clearable
                                style="width: 200px" />
                        </Form-item>
                        ...
                        <Form-item style="position:fixed;right:50px;top:130px">
                            <Button type="info" @click="showFilterPanelFlag = !showFilterPanelFlag"
                                class="showFilterPanelFlag" icon="md-settings" size="small" ghost>
                                列筛选</Button>
                            <Button type="warning" @click="modal1 = true" class="showFilterPanelFlag"
                                icon="ios-help-circle-outline" size="small" ghost>
                                使用教程</Button>
            ...
            <Row>
                <Table :loading="loading" :height="tableHeight" border stripe size="small" :columns="columns" :data="data"
            ...
            <Row type="flex" justify="end" class="page">
                <Page :current="searchForm.pageNumber" :total="total" :page-size="searchForm.pageSize"
                    @on-change="changePage" @on-page-size-change="changePageSize" :page-size-opts="[15, 20, 50]" size="small"
                            ...
                            <Form ref="form" :model="form" :rules="formValidate" label-position="top">
                                <Tabs :value="chooseName" @on-click="changeTab">
                                    <TabPane label="基础信息" name="name1">
                                        <Row :gutter="32">
                                            <Divider>
                                                <Button v-if="!isEdit" type="error" :loading="submitLoading"
                                                    @click="submitFx">保存信息</Button>
                                                <Button v-if="isEdit" type="error" :loading="submitLoading"
                                                    @click="isEdit = false">开始编辑</Button>
                                            </Divider>
                                        </Row>
                                        <Row :gutter="32">
                                            <Col span="20">
                                            ...
                                            <Row :gutter="32">
                                                ...
                                                <FormItem label="年龄" prop="age">
                                                    <InputNumber :max="120" :min="0" v-model="selectRow.age"
                                                        :readonly="isEdit"></InputNumber>
                                                </FormItem>
                                                </Col>
                                            </Row>
                                            </Col>
                                            <Col span="4">
                                            <img :src="onePhotoSrc"
                                                style="width:100px;height:150px;border:1px solid #000;" />
                                            </Col>
                                        </Row>
                                        <Row :gutter="32">
                                            <Col span="8">
                                    ...
                                    <TabPane label="社保情况" name="name2">
                                        ...
                                        <Row :gutter="32">
                                            ...
                                            <FormItem label="余额" prop="money">
                                                <InputNumber :max="100000" :min="0" v-model="selectRow.money"
                                                    :readonly="isEdit"></InputNumber>
                                            </FormItem>
                                            </Col>
                                            <Col span="12">
                                            <FormItem label="保险类型" prop="insuranceType">
                                                <Select v-model="selectRow.insuranceType" :disabled="isEdit">
                                                    <Option v-for="(item, index) in insuranceList" :value="item.id"
                                    ...
                                    <TabPane label="参保情况" name="name3">
                                        <card>
                                            ...
                                            <div v-else>
                                                <span style="color:#ff0000;font-size:26px;"> 当前选择人员：
                                                    {{ selectRow.name }}</span>
                                            </div>
                                        </card>
                                        <card>
                                        ...
                                        <card>
                                            ...
                                            <div v-else-if="selectRow.status == 0">
                                                <span style="color:#ff0000;font-size:26px;">退保操作：</span><Button
                                                    @click="disableOneFx" type="error" :size="large">退保</Button>
                                            </div>
                                            <div v-else>
                                                <span style="color:#ff0000;font-size:26px;">退保操作：</span><Button
                                                    @click="enableOneFx" type="warning" :size="large">参保</Button>
                                            </div>
                                        </card>
                                        <card>
                                            <div v-if="selectRow.status == -2">

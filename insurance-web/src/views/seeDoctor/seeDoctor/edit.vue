        ...
        <Card>
            ...
            <Form ref="form" :model="form" :label-width="100" :rules="formValidate" label-position="left">
                ...
                <FormItem label="药物费用" prop="medicinePrice">
                    <InputNumber v-model="form.medicinePrice" readonly min="0" max="5000000" style="width:570px">
                    </InputNumber>
                </FormItem>
                <FormItem label="药物原价" prop="medicineOld">
                    <InputNumber v-model="form.medicineOld" readonly min="0" max="5000000" style="width:570px">
                    </InputNumber>
                </FormItem>
                <FormItem label="药物优惠" prop="priceDiscount">
                    <InputNumber v-model="form.priceDiscount" readonly min="0" max="5000000" style="width:570px">
                    </InputNumber>
                </FormItem>

package com.mlinyun.insurance.basics.log;
...
import com.mlinyun.insurance.basics.utils.ThreadPoolUtil;
...
public class SystemLogAspect {
    ...
    @Pointcut("@annotation(com.mlinyun.insurance.basics.log.SystemLog)")

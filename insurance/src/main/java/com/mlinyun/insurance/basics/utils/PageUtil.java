...
public class PageUtil {
    ...
    public static Pageable initPage(PageVo page) {
        ...
        if (!InsNullUtils.isNull(sort)) {
            Sort.Direction direction = InsNullUtils.isNull(order) ? Sort.Direction.DESC : Sort.Direction.valueOf(order.toUpperCase());
    ...
    public static String camel2Underline(String underlineContent) {
        if (InsNullUtils.isNull(underlineContent)) {
            return NULL_STR;
        }

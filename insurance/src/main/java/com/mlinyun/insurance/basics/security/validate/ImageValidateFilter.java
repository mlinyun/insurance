package com.mlinyun.insurance.basics.security.validate;

import com.mlinyun.insurance.basics.utils.ResponseUtil;
import com.mlinyun.insurance.basics.parameter.CaptchaProperties;
...
public class ImageValidateFilter extends OncePerRequestFilter {
    ...
    protected void doFilterInternal(HttpServletRequest request, HttpServletResponse response, FilterChain filterChain) throws ServletException, IOException {
        ...
        if (InsNullUtils.isNull(userInputCode) || InsNullUtils.isNull(verificationCodeId)) {
        ...
        if (InsNullUtils.isNull(codeAnsInRedis)) {

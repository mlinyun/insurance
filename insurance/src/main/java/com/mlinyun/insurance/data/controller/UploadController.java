...
import com.mlinyun.insurance.basics.utils.Base64DecodeMultipartFile;
...
public class UploadController {
    ...
    public Result<Object> upload(@RequestParam(required = false) MultipartFile file, @RequestParam(required = false) String base64) {
        ...
        try {
            ...
            result = insFileUtils.inputStreamUpload(inputStream, fKey, file);
            f.setLocation(0);
